...
function Ticket(props) {
  ...
  const durationMinutesFirst = props.segments[0].duration - durationHoursFirst * 60

  const durationHoursSecond = Math.floor(props.segments[1].duration / 60)
  const durationMinutesSecond = props.segments[1].duration - durationHoursSecond * 60
  ...
  let dateEndFirst = add(dateFirst, { hours: durationHoursFirst, minutes: durationMinutesFirst })
  let dateEndSecond = add(dateSecond, { hours: durationHoursSecond, minutes: durationMinutesSecond })
